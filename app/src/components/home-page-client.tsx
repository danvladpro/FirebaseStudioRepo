...
export const LEVEL_THRESHOLDS = [
    { level: 'Rookie', xp: 0, icon: <Image src="/Level0.svg" alt="Rookie" width={80} height={80} /> },
    { level: 'Apprentice', xp: 50, icon: <Image src="/Level1.svg" alt="Apprentice" width={80} height={80} /> },
    { level: 'Master', xp: 120, icon: <Image src="/Level2.svg" alt="Master" width={80} height={80} /> },
    { level: 'Ninja', xp: 200, icon: <Image src="/Level3.svg" alt="Ninja" width={80} height={80} /> }
];
...
export function HomePageClient({ examSets }: HomePageClientProps) {
  const { isLoaded, stats, totalXP } = usePerformanceTracker();
