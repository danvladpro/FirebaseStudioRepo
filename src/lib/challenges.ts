...
export const CHALLENGE_SETS: ChallengeSet[] = [
  {
    ...
    challenges: [
      ...
      { description: "Apply the Percentage format", keys: ["Control", "Shift", "%"], iconName: "Percent" },
    ],
  },
  {
  ...
  },
  {
    ...
    challenges: [
      ...
      { description: "Unhide any hidden rows within the selection", keys: ["Control", "Shift", "9"], iconName: "Eye" },
