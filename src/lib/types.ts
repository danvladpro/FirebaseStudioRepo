...
export type DialogEffectAction = 
  ...
  | 'SHOW_CREATE_TABLE' 
  | 'HIDE_CREATE_TABLE' 
  | 'HIGHLIGHT_CREATE_TABLE_OK' 
  | 'SHOW_GO_TO' 
  | 'HIDE_GO_TO' 
  | 'SET_GO_TO_REF' 
  | 'HIGHLIGHT_GO_TO_OK' 
  | 'HIGHLIGHT_GO_TO_INPUT' 
  | 'SHOW_FILTER_DROPDOWN' 
  | 'HIDE_FILTER_DROPDOWN' 
  | 'HIGHLIGHT_NEXT_FILTER_ITEM' 
  | 'TOGGLE_FILTER_ITEM' 
  | 'SHOW_SORT_DIALOG' 
  | 'HIDE_SORT_DIALOG' 
  | 'SHOW_FORMAT_CELLS_DIALOG' 
  | 'HIDE_FORMAT_CELLS_DIALOG' 
  | 'MOVE_FORMAT_CELLS_HIGHLIGHT'
  | 'SHOW_FILL_COLOR_DROPDOWN' 
  | 'HIDE_FILL_COLOR_DROPDOWN' 
