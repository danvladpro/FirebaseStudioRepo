...
export function ContactSalesCta() {
  return (
    <ContactTrigger
      ...
      title="Contact Sales"
      description="Interested in Excel Ninja for your team? Send us a note and we'll get back to you with custom pricing."
      mailSubject="Excel Ninja — Team Inquiry"
    >
      Contact Sales
    </ContactTrigger>
  );
...
export function ContactFooterLink() {
  return (
    <ContactTrigger
      ...
      mailSubject="Excel Ninja — Contact"
    >
      Contact
    </ContactTrigger>
  );
