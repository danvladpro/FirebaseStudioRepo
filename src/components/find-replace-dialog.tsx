        ...
        <Tabs value={state.activeTab} className="w-full">
          ...
          <TabsContent value="find" className="p-4 space-y-4 mt-0">
            <div className="grid w-full items-center gap-1.5">
              ...
              <Input type="text" id="find-what-find" value={state.findValue || ''} readOnly className={getInputClass('find')} />
            </div>
          </TabsContent>
          <TabsContent value="replace" className="p-4 space-y-4 mt-0">
            <div className="grid w-full items-center gap-1.5">
              <Label htmlFor="find-what-replace">Find what:</Label>
              <Input type="text" id="find-what-replace" value={state.findValue || ''} readOnly className={getInputClass('find')} />
            </div>
            <div className="grid w-full items-center gap-1.5">
              <Label htmlFor="replace-with">Replace with:</Label>
              <Input type="text" id="replace-with" value={state.replaceValue || ''} readOnly className={getInputClass('replace')} />
            </div>
          </TabsContent>
        </Tabs>
      </CardContent>
